...
public class CategoryBeatlesFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.category_beatles, R.drawable.beatles, R.string.category_beatles_description, R.string.category_enter, R.drawable.category_switch));
